                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        <button type="button" rel="tooltip" class="btn btn-info" onclick="window.open('sessao_cliente/fotos_cliente.php?codigo_cliente=<?php echo codifica($cliente["codigo_cliente"]);?>', '_self')">
