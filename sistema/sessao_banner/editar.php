...
$sql_consulta_banner = "SELECT codigo_banner, codigo_tipo_banner, titulo_banner, data_inicial, ordem_banner, link_banner, data_final, arquivo, status FROM banner WHERE codigo_banner = '".$codigo_banner."'";
