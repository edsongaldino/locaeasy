...
if($_GET["codigo_banner"]){
    ...
    if($error_log){
        redireciona("/sistema/sessao_banner/consultar.php?me=".codifica(1,true)."&mm=".codifica("Ops, algo deu errado ao excluir a banner!")); 
    }else{
        redireciona("/sistema/sessao_banner/consultar.php?me=".codifica(0,false)."&mm=".codifica("A banner foi removida com sucesso!")); 
    }
