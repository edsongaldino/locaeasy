                                    ...
                                    <div class="row">
                                        ...
                                        <label class="col-sm-2 label-on-left">Subtitulo</label>
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                    ...
                                    <div class="row">
                                        <legend class="col-sm-2 label-on-left">Imagem Corpo / Página</legend>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <?php if($texto["banner"]):?>
                                                <img src="../../conteudos/texto/<?php echo $texto["banner"];?>" alt="...">
                                                <?php else:?>
                                                <img src="../../sistema/assets/img/image_placeholder.jpg" alt="...">
                                                <?php endif;?>
                                            </div>
